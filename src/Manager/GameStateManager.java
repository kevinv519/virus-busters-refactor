...
import GameState.ContinueState;
...
public class GameStateManager {
    ...
    /**
     * Quita el ultimo GameState que esta en la lista
     */
    ...
    /**
     * Quita el ultimo GameState de la lista y pone uno nuevo al final;
     * @param state 
     */
    ///Elimina el ultimo GameState de la lista y agrega uno nuevo
    ...
    /**
     * Actualiza la logica del GameState en ejecucion
     */
    public void update(){
        if (paused)
            pauseState.update();
    ...
    /**
     * Dibuja los elementos del GameState en ejecucion
     * @param g 
     * Graphics2D
     */
    ...
    /**
     * Metodo que devuelve el ultimo GameState de la lista
     */
